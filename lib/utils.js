    ...
    models.forEach(modelName => {
      ...
      if (typeof Model.observe === 'function') {
        ...
        Model.observe('access', (ctx, next) => {
          const currentUser = ctx.options && ctx.options.remotingContext &&
            ctx.options.remotingContext.getUser();
          ...
          if (currentUser) {
            ...
            const groupAccessApplied = ctx.options.remotingContext &&
              ctx.options.remotingContext.req.groupAccessApplied || false;
